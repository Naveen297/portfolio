...
//       <pointLight position={[5, 5, 5]} intensity={100} color="#22d3ee" />
//       <pointLight position={[-5, -5, 5]} intensity={50} color="#a855f7" />
      
//       {/* Tech Icons */}
//       <FloatingTechIcon position={[-3, 0, 1]} color="#61dafb" rotationSpeed={0.8} />
//       <FloatingTechIcon position={[-1, 0.5, -1]} color="#22d3ee" rotationSpeed={1.2} />
//       <FloatingTechIcon position={[1, -0.3, 2]} color="#a855f7" rotationSpeed={0.9} />
//       <FloatingTechIcon position={[3, 0.2, 0]} color="#10b981" rotationSpeed={1.1} />
...
// const Footer = () => {
//   const techStack = [
//     { name: 'React.js', icon: '⚛️', color: 'text-cyan-400', description: 'Frontend Framework' },
//     { name: 'Three.js', icon: '🎯', color: 'text-purple-400', description: '3D Graphics' },
//     { name: 'Vanta.js', icon: '🌊', color: 'text-blue-400', description: 'Animated Backgrounds' },
//     { name: 'TailwindCSS', icon: '🎨', color: 'text-teal-400', description: 'Styling' },
//     { name: 'Framer Motion', icon: '🎭', color: 'text-pink-400', description: 'Animations' },
//     { name: 'Node.js', icon: '🟢', color: 'text-green-400', description: 'Backend' },
//     { name: 'Python', icon: '🐍', color: 'text-yellow-400', description: 'Backend Logic' },
//     { name: 'MongoDB', icon: '🍃', color: 'text-emerald-400', description: 'Database' }
//   ];
...
//       {/* Gradient Overlay */}
//       <div className="absolute inset-0 bg-gradient-to-t via-transparent from-gray-900/90 to-gray-900/90"></div>
...
//                   className={`p-3 bg-gray-800/50 rounded-lg border border-gray-600/50 text-gray-400 transition-all duration-300 ${social.color} hover:border-gray-500 hover:bg-gray-700/50`}
...
//                 <motion.div
//                   key={tech.name}
//                   className="p-4 bg-gradient-to-br rounded-xl border transition-all duration-300 from-gray-800/50 to-gray-900/50 border-gray-600/30 hover:border-gray-500/50 group"
//                   whileHover={{ 
//                     scale: 1.05, 
//                     y: -5,
//                     rotateY: 5,
...
//             {/* Performance Badge */}
//             <motion.div 
//               className="flex gap-2 items-center px-4 py-2 bg-gradient-to-r rounded-full border from-green-500/20 to-emerald-500/20 border-green-400/30"
