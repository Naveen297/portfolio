      ...
      <div className="container relative z-10 px-6 mx-auto">
        <div className="grid gap-12 items-center lg:grid-cols-2">
          <div className="text-center lg:text-left animate-fade-in-up">
            <h1 className="mb-6 text-4xl font-bold leading-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 drop-shadow-lg md:text-5xl lg:text-6xl font-georama">
              Naveen Malhotra
            </h1>
            
            <div className="flex flex-wrap gap-2 justify-center mb-6 lg:justify-start font-georamalight">
            ...
            <p className="mb-8 text-lg text-gray-100 drop-shadow-md md:text-xl font-georama">
              Building immersive web experiences with cutting-edge technologies. 
            </p>
            
            <div className="flex flex-col gap-4 items-center sm:flex-row lg:justify-start font-georamalight">
              <button
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 left-1/2 text-center transform -translate-x-1/2 -translate-y-1/2">
                <div className="p-6 bg-gradient-to-br rounded-full border backdrop-blur-md from-cyan-500/20 to-purple-500/20 border-white/20">
                  ...
                  <p className="text-sm font-semibold text-white font-georamalight">Developer</p>
                </div>
              </div>
            </div>
          </div>
