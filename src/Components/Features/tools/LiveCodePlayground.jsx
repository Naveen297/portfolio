...
//================================================================================
const QuantumInterfaceWarning = () => (
  <div className="quantum-warning">
    <motion.div
      className="quantum-warning-box"
    ...
    >
      ...
      <motion.h2
        className="mb-4 text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500"
        animate={{
          backgroundPosition: ['0% 50%', '100% 50%', '0% 50%'],
        }}
        transition={{
      ...
      >
        Quantum Interface Anomaly
      </motion.h2>
      <p className="mb-2 text-lg text-center text-gray-300">
        Greetings, Quantum Explorer!
      </p>
      <p className="leading-relaxed text-center text-gray-400 text-md">
        This experimental interface requires a wider viewport to fully render the quantum phenomena. For an optimal experience, please access this playground on a desktop or larger screen.
      </p>

      <motion.div
        className="absolute inset-0 rounded-lg border-2 pointer-events-none border-cyan-400/20"
        animate={{
          boxShadow: [
            '0 0 20px rgba(34, 211, 238, 0.3)',
            '0 0 40px rgba(34, 211, 238, 0.1)',
...
${JSON.stringify(controls, null, 2)}`;
  ...
  return (
    <>
      <div className="flex overflow-hidden relative h-screen text-white bg-gradient-to-br from-gray-900 via-black to-gray-900 playground-container">
        {/* Animated background elements */}
        <div className="overflow-hidden absolute inset-0 pointer-events-none">
          <motion.div
            className="absolute w-96 h-96 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full opacity-10 blur-3xl"
      ...
      <style jsx>{`
        ...
        .quantum-warning {
          ...
          position: fixed;
          inset: 0;
          background: linear-gradient(to bottom, #000008, #000);
          z-index: 1000;
